...
public class Interface extends javax.swing.JFrame {  
    ...
    private void initComponents() {
        ...
        setTitle("mEDSR-STORM");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel1.setText("Input");

        jTextField1.setText("C:\\Users\\JN Wu\\Desktop\\cpp\\cpp\\data");
        ...
        jLabel7.setText("ModelType");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("512*512");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // 
        System.loadLibrary("mEDSR-STORM");
        ...
        */
        ...
        String inputDataDir  = jTextField1.getText();        
        String outputDataDir = jTextField2.getText();
        double batchSize = Double.parseDouble(jTextField3.getText());
        double amplification = Double.parseDouble(jTextField4.getText());
        
        double modelType;
        boolean isSelected1 = jRadioButton1.isSelected();
        ...
        dll Rs = new dll();
        Rs.Initialization(inputDataDir, outputDataDir, batchSize, modelType,amplification, fp16);

       //new dll().PIInitialization(xxxxxx,xxx);
